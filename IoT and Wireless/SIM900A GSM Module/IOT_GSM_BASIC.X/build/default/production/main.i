...
# 9 "./Configuration_Header_File.h" 2
...
# 1 "./USART_Source_File.c" 1


# 1 "./USART_Header_File.h" 1
# 14 "./USART_Header_File.h"
...
char buff[160];
volatile char status_flag;
volatile int a;
# 3 "./USART_Source_File.c" 2
...
void GSM_Init()
{
 ...
 MSdelay(300);
    ...
    USART_SendString("AT+GMI\r");
    GSM_Response();
 MSdelay(300);

 USART_SendString("AT+GMM\r");
    GSM_Response();
 MSdelay(300);

 USART_SendString("AT+GSN\r");
    GSM_Response();
 MSdelay(300);

 USART_SendString("AT+CSPN?\r");
    GSM_Response();
 MSdelay(300);
...
void display_adc(void)
{
    ...
    while(1)
    {
        ...
        voltage_01= digital_01*((float)5.00/(float)1023);
        voltage_02= digital_02*((float)5.00/(float)1023);
